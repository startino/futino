...
<div class={$$props.class}>
  ...
  {:else if $$props.icon.toLowerCase() == "cross"}
    <svg
      ...
      /></svg
    >
  {:else if $$props.icon.toLowerCase() == "safety"}
    <svg
      viewBox="0 0 24 24"
      width={$$props.width}
      height={$$props.height}
    ...
    >
  {:else if $$props.icon.toLowerCase() == "design"}
    <svg
      version="1.1"
      id="DESIGN"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
  {:else if $$props.icon.toLowerCase() == "repair"}
    <svg
      width={$$props.width}
      height={$$props.height}
      fill="currentColor"
      ...
      ></svg
    >
  {:else if $$props.icon.toLowerCase() == "construction"}
    <svg
      viewBox="0 0 24 24"
      width={$$props.width}
      height={$$props.height}
    ...
    >
  {:else if $$props.icon.toLowerCase() == "maintenance"}
    <svg
      viewBox="0 0 24 24"
      width={$$props.width}
      height={$$props.height}
    ...
    >
  {:else if $$props.icon.toLowerCase() == "quotation-mark"}
    <svg
      width={$$props.width}
      height={$$props.height}
      aria-hidden="true"
