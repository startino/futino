...
<div class={$$props.class}>
	...
	{:else if $$props.icon.toLowerCase() == 'burger'}
		<svg width={$$props.width} height={$$props.height} fill="none" viewBox="0 0 24 24">
			<path
				stroke-linecap="round"
				stroke-linejoin="round"
				stroke-width="2"
	...
	{:else if $$props.icon.toLowerCase() == 'cross'}
		<svg viewBox="0 0 10 10" width={$$props.width} height={$$props.height} fill="currentColor"
			><path d="M0 0L10 10M10 0L0 10" fill="none" stroke-width="1" stroke-linecap="round" /></svg>
	{:else}
		'icon' not given...
	{/if}
</div>
