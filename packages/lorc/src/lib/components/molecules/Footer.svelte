<script lang="ts">
	...
	export const border: string = 'border-outline dark:border-outline';
</script>
...
<footer class="max-w-none prose-a:no-underline prose sm:prose-sm lg:prose-md prose-main">
	<div class="px-6 md:px-18 lg:max-w-5xl xl:max-w-6xl mx-auto">
		<div
			...
			<div class="flex flex-row gap-12 mt-3 sm:mt-0 w-fit justify-self-center justify-items-center">
