...
<!--Hero-->
<div
	class="card-shadow h-screen grid-rows-2 place-items-center border-b border-secondary/40 bg-contact bg-cover bg-center object-contain px-10 pt-56 shadow-lg shadow-background lg:grid-cols-2 lg:px-20 xl:px-40"
>
	<div
...
<div id="form" class="inner-section border-b border-primary/40 shadow-2xl">
	<!--Contact Section-->
	<div
		class="xs:mx-4 mx-10 my-20 grid justify-items-center gap-6 sm:mx-10 md:mx-20 md:grid-cols-2 lg:mx-32"
	>
		<div class="flex max-w-xl flex-col gap-6 rounded-xl bg-surface px-10 py-10">
		...
		<div
			class="absolute mx-auto aspect-video w-full max-w-xl rounded-lg"
