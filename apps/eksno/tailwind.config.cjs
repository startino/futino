      ...
      typography: ({ colors }) => ({
        main: {
          css: {
            ...
            "--tw-prose-invert-links": fColors.tertiary.DEFAULT.replace(
              alpha,
              1,
            ),
            "--tw-prose-invert-bold": colors.white,
            "--tw-prose-invert-counters": colors.neutral[400],
            "--tw-prose-invert-bullets": fColors.secondary.DEFAULT.replace(
              alpha,
              0.4,
            ),
            ...
            "--tw-prose-invert-quote-borders":
              fColors.secondary.DEFAULT.replace(alpha, 0.3),
