...
<div
	class="{$$props.class} top-0 z-40 flex-none w-full transition-colors duration-500 backdrop-blur  dark:bg-primary-container-dark/5  dark:text-primary-container-on-dark">
	<div class="py-2 mx-5 border-b  dark:border-secondary-dark/10">
		<div class="flex relative items-center md:px-10 lg:px-20 xl:px-40 px-auto md:px-auto">
			...
			<div class="flex items-center ml-auto">
				<nav class="text-sm font-semibold">
					<ul
						class="flex m-auto space-x-3 sm:space-x-6 md:space-x-12  dark:text-surface-on-dark items-center">
						<li class="dark:hover:">
						...
						<li
							class=" dark:hover:text-secondary-on-dark dark:hover:bg-secondary-dark p-2 sm:p-3 w-max">
							<a class="inline" href="tel:9133600394">
								<h1 class="body-small md:body-large ">(913) 360-0394</h1>
							</a>
						</li>
