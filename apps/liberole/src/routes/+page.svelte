				...
				<section class="flex h-full w-full p-5 space-x-5">
					<button on:click={previousPage}>
						<svg
							...
							clip-rule="evenodd"
							><path
								d="M20 .755l-14.374 11.245 14.374 11.219-.619.781-15.381-12 15.391-12 .609.755z" /></svg>
					</button>
					...
					<button on:click={nextPage}>
						<svg
							...
							clip-rule="evenodd"
							><path
								d="M4 .755l14.374 11.245-14.374 11.219.619.781 15.381-12-15.391-12-.609.755z" /></svg>
					</button>
				</section>
			</div>
		{/if}
