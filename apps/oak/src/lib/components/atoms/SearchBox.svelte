...
<div
  class="relative max-w-3xl {$$props.class} flex flex-row items-center rounded-lg border border-primary bg-surface drop-shadow-glow-sm placeholder-surface-on"
>
  <Icon
    icon="search"
