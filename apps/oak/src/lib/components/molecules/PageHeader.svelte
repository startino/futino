...
<header class="antialiased">
	<nav class="border-gray-200 bg-white px-4 py-2.5 lg:px-6 dark:bg-card">
						...
						<li>
							...
							>
								<span class="flex items-center">
									<svg
										class="text-primary-600 dark:text-primary-500 mr-2 h-4 w-4"
										aria-hidden="true"
										xmlns="http://www.w3.org/2000/svg"
										fill="currentColor"
										viewBox="0 0 20 20"
