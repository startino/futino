...
<div class="hidden h-full overflow-y-clip lg:z-50 lg:flex lg:w-72 lg:flex-col">
	...
	<div class="bg-primary flex grow flex-col gap-y-5 px-6 pb-6 text-white">
		...
		<nav class="flex flex-col pt-0 sm:mt-0 sm:pt-0">
			<ul role="list" class="flex list-none flex-col gap-y-7 pl-0 sm:mt-0 sm:pl-0">
				<li class="pl-0 sm:pl-0">
				...
				<li class="mt-auto pl-0 sm:pl-0">
					<ul role="list" class=" list-none space-y-1 pl-0 sm:pl-0">
