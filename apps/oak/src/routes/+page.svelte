...
<Prose class="h-screen -mt-10 w-full py-12">
	<!-- Hero section -->
			...
			<div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
				...
				<div class="mt-24 sm:mt-32 lg:mt-16">
					<a href="#" class="inline-flex space-x-6">
						...
						>
						<span
							class="inline-flex items-center space-x-2 text-sm   text-gray-300"
						>
				...
				<h1 class="pt-12 m-0 sm:m-0">
					Deploy to the cloud with confidence
				</h1>
				<p class="pt-6 tracking-tight text-gray-300 m-0 sm:m-0">
				...
				<div class="mt-10 flex items-center gap-x-6">
					<a
						href="#"
						class="rounded-md bg-primary-500 px-3.5 py-2.5 text-sm text-primary-foreground shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
						>Get started</a
					>
