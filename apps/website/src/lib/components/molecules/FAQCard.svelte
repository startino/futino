...
<button
	on:click={toggle}
	class="bg-surface-dark border-1 border-primary-dark/50 py-4 flex flex-col px-3 gap-y-5 rounded-md shadow-lg text-left transition-all duration-300 w-full max-w-3xl">
