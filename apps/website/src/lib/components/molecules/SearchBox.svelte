...
<div
	class="relative max-w-3xl {$$props.class} flex flex-row items-center rounded-lg border border-primary-dark bg-surface-dark drop-shadow-glow-sm-dark placeholder-surface-on-dark">
	<Icon
		icon="search"
