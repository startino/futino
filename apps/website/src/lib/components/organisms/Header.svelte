<script lang="ts">
  ...
  onMount(() => {
    window.addEventListener("scroll", () => {
      activeheaderClass =
        window.scrollY > 12 ? miniHeaderClass : largeHeaderClass;
    });
  });
</script>
...
>
  <div
    class="flex relative items-center px-6 md:px-18 lg:max-w-5xl xl:max-w-6xl mx-auto"
  >
    ...
    <div class="flex items-center ml-auto gap-8 title-large">
      ...
      <div class="gap-6 flex md:border-primary/50">
        <button
