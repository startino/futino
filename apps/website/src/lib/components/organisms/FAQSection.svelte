...
<section class="overflow-hidden relative">
	<div
		class="absolute bottom-0 w-screen bg-gradient-to-t from-background-dark to-transparent h-36" />
	<div class="inner-section grid grid-cols-1 md:grid-cols-3 items-start gap-3 h-[5000px]">
		<div
			...
			<h1 class="body-large hidden md:flex">Find Clarity and Confidence.</h1>

			<Button href="/contact" class="py-2">
			...
			{#if searchInput && filteredFaqs.length === 0}
				<section>
					<div class="w-full py-12 display-small inline">
						...
						<a href="/contact" class="underline text-tertiary-dark">Ask Us Here!</a>
					</div>
				</section>
