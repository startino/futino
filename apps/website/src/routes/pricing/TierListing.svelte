...
<section>
  <div
    class="flex flex-col place-items-start gap-2 text-left relative"
  ...
  >
    ...
    <div class="flex flex-row items-end gap-2">
      ...
      >
        ...
        >
          {cycle == "yearly"
            ? formatter.format(tier.cost * 0.833)
    ...
    <div class="grid grid-cols-2 w-full gap-y-1 px">
      {#each Object.entries(features) as [catagoryName, catagoryFeatures]}
        <div
          class="flex pb-0 grid-item col-span-2 border-none mt-2 mb-1 place-self-start"
        >
        ...
        {#each Object.entries(catagoryFeatures) as [featureName, featureAbout]}
          <div
            class="flex flex-row place-items-center gap-3 border-t-1 border-outline"
          >
          ...
          >
            ...
            {:else}
              <h2
                class="my-auto title-medium ml-auto flex place-items-end justify-self-end"
              >
