...
export const features = {
  ...
  Development: {
    Database:
      "Data management, retrievals, and submissions for your website or application.",
    "Mobile Design":
    ...
    SEO: "The process of improving your website to increase its visibility in search engines like Google.",
  },
  Hosting: {
    ...
    Uptime:
      "Percentage of time that your website is live and accessible to users.",
  },
  Integration: {
    "Yearly Meetings":
