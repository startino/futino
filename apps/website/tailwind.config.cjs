const config = {
	...
	theme: {
		extend: {
			...
			dropShadow: {
				object: ['0 0 7px rgb(var(--md-sys-color-tertiary-container-dark))'],
				...
				email: ['-5px 2px 7px #400B8DBB', '5px -2px 7px #000069BB'],
				'email-hover': ['-5px 2px 10px #400B8DFF', '5px -2px 10px #000069FF'],
				// Light
