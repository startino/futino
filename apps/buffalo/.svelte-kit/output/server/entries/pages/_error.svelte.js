...
const Error$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return ` <section class="w-full h-screen shadow-lg shadow-background card-shadow px-10 lg:px-20 xl:px-40 pt-60 place-items-center border-b border-secondary/40"><div class="flex flex-col max-w-2xl mx-auto mt-8 mb-64 text-center items-center space-y-2"><h1 class="display-large">${escape($page.status)} ${escape($page.error?.message)}</h1> ${validate_component(Button, "Button").$$render($$result, { href: "/" }, {}, {
    default: () => {
