<script lang="ts">
  ...
  import SearchBox from "lorc/components/atoms/SearchBox.svelte";
  import FaqSection from "lorc/components/organisms/FAQSection.svelte";
...
<Prose size="lg">
  ...
  <Section
    class="-translate-y-36 -mb-36 z-0 rounded-t-[50px] bg-background py-12"
  >
    <Container
    ...
    >
      ...
      <div
        class="grid grid-cols-2 gap-4 md:gap-6 place-items-center w-fit pt-12"
      >
  ...
  <Section class="bg-background">
    <Container
      class="text-center md:text-left items-start flex flex-col md:grid md:grid-cols-2 md:place-items-center gap-x-8 gap-y-4 sm:gap-y-4 md:gap-y-12"
      sizes="max-w-7xl"
    >
